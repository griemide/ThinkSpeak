...
var thingSpeakChannel = 296355;
var thingSpeakChannelName = 'af104-rkz';
var chartTitle = 'AF104 Wasseruhr (Elster Ringkolbenzaehler V200)'; // useHTML:true
var chartSubTitle = 'monitoring LJ12A3-4-Z/BX NPN-NO inductive sensor on NodeMCU (LoLin)'; // useHTML:true
var yAxisIdLtext = "Liter";
var yAxisIdRtext = "Pulse";
var field1color = 'blue';
...
var xAxesFlag1time = 1496035200000;
var xAxesFlag1text = 'V200 installed';
var xAxesFlag2time = 1496776800000;
var xAxesFlag2text = 'sensor inst.';
var xAxesFlag3time = 1497820800000;
var xAxesFlag3text = 'sensor data';
...
$(document).ready(function() {
 ...
 function createChart() {
    ...
    yAxis: [{
        ...
        labels: {useHTML:true, format: '{value}', style: {color: field2color} },
        title: {
            useHTML:true, 
            text: yAxisIdRtext,
  ...
  // added flags only after all series are added due to navigator bar display reasons
      chartOptions.series.push({    type: 'flags',
                                    ...
                                    data: 
                                    [
                                        {x: xAxesFlag1time, title: xAxesFlag1text},
                                        {x: xAxesFlag2time, title: xAxesFlag2text},
                                        {x: xAxesFlag3time, title: xAxesFlag3text}
                                    ]
                                });
